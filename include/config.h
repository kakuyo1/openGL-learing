...
namespace Paths {
	...
	constexpr std::string_view CUBE_VERTEX_SHADER_PATH = "assets/cubeShader.vert";
...
float vertices2[] = {
	...
	-0.5f,  0.5f, 0.0f,  1.0f, 1.0f, 0.0f,	0.0f, 1.0f	// вСио╫г
};
...
float vertices5[] = { // cube without normals
	-0.5f, -0.5f, -0.5f,
	 0.5f, -0.5f, -0.5f,
	 0.5f,  0.5f, -0.5f,
	 0.5f,  0.5f, -0.5f,
...
float vertices6[] = { // cube with normals
...
float vertices7[] = { // cube with normals and texture coords
